$(function(){
	...
	$(".sub_title_navi, .navi_all , .navi_in").on("mouseover", function(e){
		...
		$('#sub-menu-wrap').stop().animate({height:"0px"},300);
	...
	// $(".extend1 ul a h1").on("mouseover", function(e){
	// 		console.log("cc");
	// 		$(this).css("color", "red");
	// });

	// $(".extend1 ul a h1").on("mouseout", function(e){
	// 		console.log("out");
	// 		$(this).css("color", "#eeee");
	// });
	...
	$('span.ns_tab a').click(function(event){
		...
		$(window).scroll(function(event){
			...
			if($(".new_tab").hasClass("on")){
				$("span.ns_tab ").css("width","14.6%");
			}else{
				$("span.ns_tab ").css("width","20%");
			}
